...
final class SupplierBelumLunasTable extends PowerGridComponent
{
    public string $tableName = 'supplier-belum-lunas-table-dzora7-table';
    ...
    {
        return BarangMasuk::query()->with(['supplier', 'cabang', 'user'])->where('status_pembayaran', 'belum lunas')->orderBy('id', 'desc');
    }
