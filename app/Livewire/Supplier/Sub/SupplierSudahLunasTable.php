...
final class SupplierSudahLunasTable extends PowerGridComponent
{
    public string $tableName = 'supplier-sudah-lunas-table-himgy1-table';
    ...
    {
        return BarangMasuk::query()->with(['supplier', 'cabang', 'user'])->where('status_pembayaran', 'lunas')->orderBy('id', 'desc');
    }
    ...
    public function fields(): PowerGridFields
    {
        return PowerGrid::fields()
            ...
            ->add('status_pembayaran', function ($dish) {
                ...
                return $dish->status_pembayaran == 'lunas' ? "<span class='badge bg-success'>Lunas</span>" : "<span class='badge bg-warning'>Belum Lunas</span>";
    ...
    public function actions(BarangMasuk $row): array
    {
        return [
            ...
            //     ->dispatch('edit-barang-masuk', ['id' => $row->id]),
            Button::add('delete')
