...
final class SupplierTable extends PowerGridComponent
{
    ...
    public string $tableName = 'supplier-table-0szn0i-table';
    ...
    {
        return Supplier::query()->orderBy('id', 'desc');
    }
    ...
    public function fields(): PowerGridFields
    {
        return PowerGrid::fields()
            ...
            ->add('nama')
            ->add('telepon', fn($data) => $data->telepon ?? 'NO_DATA')
            ->add('alamat', fn($data) => $data->alamat ?? 'NO_DATA')
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make('Nama', 'nama')
                ->sortable()
                ->searchable(),
            Column::make('Nomor Telepon', 'telepon')
                ->searchable(),
