...
final class KonversiSatuanTable extends PowerGridComponent
{
    ...
    {
        return KonversiSatuan::query()->with('bahan');
    }
    ...
    public function fields(): PowerGridFields
    {
        return PowerGrid::fields()
            ->add('id')
            ->add('bahan_id', fn(KonversiSatuan $model) => $model->bahan->nama)
            ->add('satuan_awal')
            ->add('satuan_tujuan')
            ->add('rasio')
            ->add('catatan')
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make('Satuan awal', 'satuan_awal')
                ->sortable()
                ->searchable(),

            Column::make('Satuan tujuan', 'satuan_tujuan')
                ->sortable()
                ->searchable(),

            Column::make('Rasio', 'rasio')
                ->sortable()
                ->searchable(),
    ...
    public function actions(KonversiSatuan $row): array
    {
        return [
            Button::add('edit')
