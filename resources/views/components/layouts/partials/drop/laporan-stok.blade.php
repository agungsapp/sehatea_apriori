      ...
      @php
        $currentRoute = ['laporan.stok'];

        $masterDataItems = [
            ['route' => 'laporan.stok', 'text' => 'Semua'],
      ...
      <li class="nav-item {{ in_array(Route::currentRouteName(), $currentRoute) ? 'active' : '' }}">
        <span
          ...
          data-bs-toggle="collapse" data-bs-target="#submenu-laporan-stok">
          <span>
        ...
        <div
          ...
          role="list" id="submenu-laporan-stok" aria-expanded="false">
