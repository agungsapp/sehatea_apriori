      ...
      @php
        $currentRoute = ['pelanggan', 'transaksi-sudah-lunas', 'transaksi-belum-lunas'];
      @endphp
      ...
      <li class="nav-item {{ in_array(Route::currentRouteName(), $currentRoute) ? 'active' : '' }}">
        <span
          ...
          data-bs-toggle="collapse" data-bs-target="#submenu-pelanggan">
          <span>
        ...
        <div
          ...
          role="list" id="submenu-pelanggan" aria-expanded="false">
          @php
            $masterDataItems = [
                ['route' => 'pelanggan', 'text' => 'Semua'],
