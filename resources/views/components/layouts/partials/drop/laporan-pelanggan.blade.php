      ...
      @php
        $currentRoute = ['laporan.pelanggan'];

        $masterDataItems = [
            ['route' => 'laporan.pelanggan', 'text' => 'Semua'],
      ...
      <li class="nav-item {{ in_array(Route::currentRouteName(), $currentRoute) ? 'active' : '' }}">
        <span
          ...
          data-bs-toggle="collapse" data-bs-target="#submenu-laporan-pelanggan">
          <span>
        ...
        <div
          ...
          role="list" id="submenu-laporan-pelanggan" aria-expanded="false">
