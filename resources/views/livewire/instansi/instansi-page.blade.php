<div class="row gap-3">
  ...
  <div class="row">
    <div class="card">
      <div class="card-header">
        <div class="card-title">Tambah instansi baru </div>
      </div>
      <form wire:submit.prevent="save">
        <div class="card-body">
          <div class="mb-3">
            <label for="nama" class="form-label wajib">Nama Instansi</label>
            <input type="text" class="form-control @error('nama') is-invalid @enderror" id="nama"
              wire:model="nama" placeholder="Nama instansi...">
            @error('nama')
              <div class="invalid-feedback">{{ $message }}</div>
            @enderror
          </div>
          <div class="mb-3">
            <label for="telepon" class="form-label wajib">Nomor Telepon</label>
          ...
          <div class="mb-3">
            <label for="alamat" class="form-label wajib">Alamat</label>
  ...
  <div class="row">
    <div class="card">
      <div class="card-body">
        <livewire:instansi.instansi-table />
      </div>
    </div>
  </div>
</div>
