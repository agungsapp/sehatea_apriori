...
<div class="row gap-3">
  <div class="row">
    <h1>History Transaksi Belum Lunas</h1>
  </div>
  <div class="card">
    ...
    <div class="card-body">
      ...
      <livewire:transaksi.transaksi-table status="belum lunas" />
    </div>
  </div>
                  ...
                  <table class="table table-borderless">
                    ...
                    @else
                      <tr>
                        ...
                        <td>:</td>
                        <td>{{ $transaksi->pelangganKendaraan->instansi->nama_instansi }}</td>
                      </tr>
                    @endif
                    <tr>
