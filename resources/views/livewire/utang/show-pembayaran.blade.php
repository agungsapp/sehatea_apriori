<div class="row gap-3">
  ...
  <div class="row ">
    <div class="d-flex justify-content-between">
      ...
      <h2>No Invoice : <span class="btn btn-primary">{{ $barangMasuk->no_invoice }}</span></h2>
    </div>
  </div>
            ...
            <div class="row">
              ...
              <div class="col-4 mb-3">
                ...
                <input type="text" class="form-control @error('sisa') is-invalid @enderror" id="sisa"
                  value="{{ Str::rupiah($sisa) }}" placeholder="sisa hutang..."
                  style="background-color: #e2dede !important;" readonly>
                @error('sisa')
                  <div class="invalid-feedback">{{ $message }}</div>
                @enderror
              </div>
              ...
              <div class="{{ $isTunai == true ? 'col-6' : 'col-3' }} mb-3">
                <x-input-rupiah label="Di Bayarkan" id="bayar" name="bayar" :value="$bayar" />
              ...
              {{-- <div class="col-6 mb-3">
                ...
                <div class="input-group mb-3">
                  <input type="number" class="form-control" wire:model.live.debounce.500ms="bayar" placeholder="0"
                    aria-label="Recipient's username" id="bayar" aria-describedby="bayarHelp">
                  <span class="input-group-text bg-primary text-white" id="bayarHelp">{{ Str::rupiah($bayar) }}</span>
                </div>
              </div> --}}
      ...
      @else
        <div class="card-body">
          <div class="d-flex justify-content-center align-items-center gap-3 p-3">
            <img style="width: 3vw;" src="{{ asset('icon/check.png') }}" alt="check.png" srcset="">
            <h4 class="text-center pt-4 ">Pembayaran ini sudah lunas</h4>
          </div>

          <div class="d-flex justify-content-center">
            <a href="{{ route('supplier-sudah-lunas') }}" class="btn btn-info">Lihat Data Nota Lunas </a>
          </div>
            ...
            <table class="table table-borderless">
              <tbody>
                <tr>
                  ...
                  <td>: {{ $pembayaran->barangMasuk->no_invoice }}</td>
                </tr>
                <tr>
                ...
                @if ($pembayaran->bank)
                  <tr>
                    ...
                    <td>:
                      {{ $pembayaran->bank->nama . ' - ' . $pembayaran->bank->norek . ' a/n ' . $pembayaran->bank->atas_nama }}
                    </td>
                  </tr>
                @endif
                <tr>
