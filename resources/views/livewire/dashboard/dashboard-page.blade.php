        ...
        <div class="card-body">
          <div class="row d-block d-xl-flex align-items-center">
            <div
              ...
              <div class="d-sm-none">
                <h2 class="fw-extrabold h5">Pengeluaran Belanja Bahan</h2>
        ...
        <div class="card-body">
          <div class="row d-block d-xl-flex align-items-center">
            <div
              ...
              <div class="d-sm-none">
                <h2 class="fw-extrabold h5">Pengeluaran Lain Lain</h2>
                <h3 class="mb-1">{{ Str::rupiah($pengeluaranLain) }}</h3>
              </div>
            </div>
            <div class="col-12 col-xl-7 px-xl-0">
              <div class="d-none d-sm-block">
                <h2 class="h6 text-gray-400 mb-0">Pengeluaran Lain Lain</h2>
                <h3 class="fw-extrabold mb-2">{{ Str::rupiah($pengeluaranLain) }}</h3>
              </div>
              <small class="d-flex align-items-center text-gray-500">
                {{ $this->formattedDateRange }}
              </small>
